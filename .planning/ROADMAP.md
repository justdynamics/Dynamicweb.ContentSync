...
Plans:
- [ ] 03-01-PLAN.md — Recursive page hierarchy support (Children on SerializedPage, FileSystemStore update) and INF-03 long-path tests
- [ ] 03-02-PLAN.md — DW-to-DTO mapper (ContentMapper, ReferenceResolver) and ContentSerializer orchestrator
- [ ] 03-03-PLAN.md — Integration test project and live Swift2.2 verification
...
| 3. Serialization | 0/3 | In progress | - |
